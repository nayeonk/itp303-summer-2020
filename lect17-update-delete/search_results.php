...
<?php while ( $row = $results->fetch_assoc() ) : ?>
	<tr>
		<td>
			<!-- confirm() is a JS method that returns TRUE if user clicks "Ok" and FALSE if user clicks "Cancel" -->
			<a onclick="return confirm('Are you sure you want to delete this track?');" href="delete.php?track_id=<?php echo $row['track_id']; ?>&track_name=<?php echo $row['track']?>" class="btn btn-outline-danger">
				Delete
			</a>
		</td>
		<td>
